...
#   E6_RAW_ROOT          — default: data/Pick-place-2CAM (relative to openpi repo root)
#   E6_SEGMENTS_CSV      — default: docs/gate2/episode_primitive_segments.csv (generated by build_2cam_segments.py)
...
: "${E6_RAW_ROOT:=${SCRIPT_DIR}/../../data/Pick-place-2CAM}"
: "${E6_SEGMENTS_CSV:=${SCRIPT_DIR}/../../docs/gate2/episode_primitive_segments.csv}"
